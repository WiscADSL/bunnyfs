...
////////////////////////////////////////////////////////////////////////////////
// async APIs (similar to Linux AIO)

struct async_ctx_rw {
  // args in case we need to resubmit (e.g., in the case of inode transfer)
  int fd;
  void *buf;
  size_t count;
  off_t offset;
...
// if I/O is done, put return code into *ret and return 0; otherwise, return -1
int fs_allocated_pread_poll(struct async_ctx_rw *ctx, ssize_t *ret_code);
// only return if I/O is done
