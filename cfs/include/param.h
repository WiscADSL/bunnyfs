...
#error "DEV_SIZE should be defined by CMakeFiles.txt"
#endif
...
#define SPDK_THREAD_MAX_INFLIGHT 600
...
#define DEFAULT_EXIT_FILENAME "/tmp/ufs_exit"
#define DEFAULT_READY_FILENAME "/tmp/ufs_ready"
#define DEFAULT_UFS_CONFIG "/tmp/ufs.config"
#define DEFAULT_SPDK_CONFIG "/tmp/spdk.config"

// each worker has a subspace of key, starting from its shmBaseOffset with the
// size of SHM_KEY_SUBSPACE_SIZE
#define SHM_KEY_SUBSPACE_SIZE 1000
