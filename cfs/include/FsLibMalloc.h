...
class FsLibMemMng {
 ...
 private:
  ...
  // Note: a Bus error can occur if the following sizes are set too large
  // Each thread created take up spaces specified by the following sizes
#if defined(_EXTENT_FOR_LDB_)
  constexpr static fslib_malloc_mem_sz_t kPerSizeTotalBytes[] = {
      64 * 1024 * 1024, /* 64 M for 8K pages*/
      64 * 1024 * 1024, /* 64 M for 48K pages*/
      64 * 1024 * 1024, /* 64 M for 2M pages*/
  };
