...
/**
 * This code is from Stanford Platform Lab. To avoid naming conflict, we wrap it
 * into PlatformLab namespace (also show our respect and appreciation).
 */
namespace PlatformLab {
namespace PerfUtils {
