...
// Reference:
// - The initial implementation of `mixgraph`:
//   https://github.com/facebook/rocksdb/pull/4788/files
// - The improved version w/ `keyrange_dist_[a|b|c|d]`
//   https://github.com/facebook/rocksdb/pull/5953/files
...
// Copied from https://github.com/facebook/rocksdb/blob/main/util/random.h
...
// Copied from https://github.com/facebook/rocksdb/pull/5953/files
// w/ minor modifications to get rid of FLAG_*.
...
class GenerateTwoTermExpKeys {
 public:
  ...
  GenerateTwoTermExpKeys(int64_t max, int64_t keyrange_num)
      : keyrange_rand_max_(max),
  ...
  // KeyrangeUnit.
  void InitiateExpDistribution(int64_t total_keys, double prefix_a,
    ...
    for (int64_t i = 0; i < keyrange_num_; i++) {
      int64_t pos = rand_loca.Next() % keyrange_num_;
